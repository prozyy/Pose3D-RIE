...
def parse_args():
    ...
    # TCN Model arguments
    parser.add_argument('--num-joints-in', default=17, type=int, metavar='N', help='input 2Dkeypoint joints number')
    parser.add_argument('--in-features', default=2, type=int, metavar='N', help='feature dims')
    parser.add_argument('--num-joints-out', default=17, type=int, metavar='N', help='output 3Dkeypoint joints number')
    ...
    parser.add_argument('-ch', '--channels', default=256, type=int, metavar='N', help='number of channels in convolution layers')

    # RIE Model arguments
    parser.add_argument('--stage', default=1, type=int, metavar='N', help='current stage when using the multi-stage optimization method')
    parser.add_argument('-lfd', '--latent-features-dim', default=256, type=int, metavar='N', help='dimension of the global and local features')
    ...
    parser.add_argument('--no-bone-length',
                        action='store_false',
                        dest='bone_length_term',
