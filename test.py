...
model_pos = get_model("h36m_24")(args.num_joints_in, args.in_features,
                            args.num_joints_out,
...
if torch.cuda.is_available():
    model_pos = torch.nn.DataParallel(model_pos)
...
if args.render:
    print('Rendering...')
    print(len(keypoints["input_video.mp4"]["custom"]))
    print("args.viz_subject:",args.viz_subject," args.viz_action:",args.viz_action," args.viz_camera:",args.viz_camera)
